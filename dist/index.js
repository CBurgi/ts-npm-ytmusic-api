...
var SongDetailed = _zod.z.object({
  ...
  name: _zod.z.string(),
  artists: _zod.z.array(ArtistBasic),
...
function parseArrayDef(def, refs) {
  ...
  if (_optionalChain([def, 'access', _3 => _3.type, 'optionalAccess', _4 => _4._def]) && _optionalChain([def, 'access', _5 => _5.type, 'optionalAccess', _6 => _6._def, 'optionalAccess', _7 => _7.typeName]) !== _v3.ZodFirstPartyTypeKind.ZodAny) {
...
function parseRecordDef(def, refs) {
  ...
  if (refs.target === "openApi3" && _optionalChain([def, 'access', _17 => _17.keyType, 'optionalAccess', _18 => _18._def, 'access', _19 => _19.typeName]) === _v3.ZodFirstPartyTypeKind.ZodEnum) {
    return {
      type: "object",
  ...
  if (_optionalChain([def, 'access', _20 => _20.keyType, 'optionalAccess', _21 => _21._def, 'access', _22 => _22.typeName]) === _v3.ZodFirstPartyTypeKind.ZodString && _optionalChain([def, 'access', _23 => _23.keyType, 'access', _24 => _24._def, 'access', _25 => _25.checks, 'optionalAccess', _26 => _26.length])) {
    const { type, ...keyType } = parseStringDef(def.keyType._def, refs);
    return {
      ...schema,
      propertyNames: keyType
    };
  } else if (_optionalChain([def, 'access', _27 => _27.keyType, 'optionalAccess', _28 => _28._def, 'access', _29 => _29.typeName]) === _v3.ZodFirstPartyTypeKind.ZodEnum) {
    return {
      ...schema,
      propertyNames: {
  ...
  } else if (_optionalChain([def, 'access', _30 => _30.keyType, 'optionalAccess', _31 => _31._def, 'access', _32 => _32.typeName]) === _v3.ZodFirstPartyTypeKind.ZodBranded && def.keyType._def.type._def.typeName === _v3.ZodFirstPartyTypeKind.ZodString && _optionalChain([def, 'access', _33 => _33.keyType, 'access', _34 => _34._def, 'access', _35 => _35.type, 'access', _36 => _36._def, 'access', _37 => _37.checks, 'optionalAccess', _38 => _38.length])) {
...
var selectParser = (def, typeName, refs) => {
  switch (typeName) {
    case _v3.ZodFirstPartyTypeKind.ZodString:
      return parseStringDef(def, refs);
    case _v3.ZodFirstPartyTypeKind.ZodNumber:
      return parseNumberDef(def, refs);
    case _v3.ZodFirstPartyTypeKind.ZodObject:
      return parseObjectDef(def, refs);
    case _v3.ZodFirstPartyTypeKind.ZodBigInt:
      return parseBigintDef(def, refs);
    case _v3.ZodFirstPartyTypeKind.ZodBoolean:
      return parseBooleanDef();
    case _v3.ZodFirstPartyTypeKind.ZodDate:
      return parseDateDef(def, refs);
    case _v3.ZodFirstPartyTypeKind.ZodUndefined:
      return parseUndefinedDef(refs);
    case _v3.ZodFirstPartyTypeKind.ZodNull:
      return parseNullDef(refs);
    case _v3.ZodFirstPartyTypeKind.ZodArray:
      return parseArrayDef(def, refs);
    case _v3.ZodFirstPartyTypeKind.ZodUnion:
    case _v3.ZodFirstPartyTypeKind.ZodDiscriminatedUnion:
      return parseUnionDef(def, refs);
    case _v3.ZodFirstPartyTypeKind.ZodIntersection:
      return parseIntersectionDef(def, refs);
    case _v3.ZodFirstPartyTypeKind.ZodTuple:
      return parseTupleDef(def, refs);
    case _v3.ZodFirstPartyTypeKind.ZodRecord:
      return parseRecordDef(def, refs);
    case _v3.ZodFirstPartyTypeKind.ZodLiteral:
      return parseLiteralDef(def, refs);
    case _v3.ZodFirstPartyTypeKind.ZodEnum:
      return parseEnumDef(def);
    case _v3.ZodFirstPartyTypeKind.ZodNativeEnum:
      return parseNativeEnumDef(def);
    case _v3.ZodFirstPartyTypeKind.ZodNullable:
      return parseNullableDef(def, refs);
    case _v3.ZodFirstPartyTypeKind.ZodOptional:
      return parseOptionalDef(def, refs);
    case _v3.ZodFirstPartyTypeKind.ZodMap:
      return parseMapDef(def, refs);
    case _v3.ZodFirstPartyTypeKind.ZodSet:
      return parseSetDef(def, refs);
    case _v3.ZodFirstPartyTypeKind.ZodLazy:
      return () => def.getter()._def;
    case _v3.ZodFirstPartyTypeKind.ZodPromise:
      return parsePromiseDef(def, refs);
    case _v3.ZodFirstPartyTypeKind.ZodNaN:
    case _v3.ZodFirstPartyTypeKind.ZodNever:
      return parseNeverDef(refs);
    case _v3.ZodFirstPartyTypeKind.ZodEffects:
      return parseEffectsDef(def, refs);
    case _v3.ZodFirstPartyTypeKind.ZodAny:
      return parseAnyDef(refs);
    case _v3.ZodFirstPartyTypeKind.ZodUnknown:
      return parseUnknownDef(refs);
    case _v3.ZodFirstPartyTypeKind.ZodDefault:
      return parseDefaultDef(def, refs);
    case _v3.ZodFirstPartyTypeKind.ZodBranded:
      return parseBrandedDef(def, refs);
    case _v3.ZodFirstPartyTypeKind.ZodReadonly:
      return parseReadonlyDef(def, refs);
    case _v3.ZodFirstPartyTypeKind.ZodCatch:
      return parseCatchDef(def, refs);
    case _v3.ZodFirstPartyTypeKind.ZodPipeline:
      return parsePipelineDef(def, refs);
    case _v3.ZodFirstPartyTypeKind.ZodFunction:
    case _v3.ZodFirstPartyTypeKind.ZodVoid:
    case _v3.ZodFirstPartyTypeKind.ZodSymbol:
      return void 0;
    default:
...
var SongParser = class _SongParser {
  ...
  static parseArtistSong(item, artistBasic) {
    ...
    const artists = artistRuns.length > 0 ? artistRuns.map((a) => ({
      name: traverseString(a, "text"),
      artistId: traverseString(a, "browseId") || null
    })) : [artistBasic];
...
var AlbumParser = class _AlbumParser {
  static parse(data, albumId) {
    ...
    const songs = traverseList(data, "musicResponsiveListItemRenderer").map(
